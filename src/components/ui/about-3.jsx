...
const defaultAchievements = [
  { label: 'Learners Supported', value: '50K+' },
  { label: 'Lessons Completed', value: '200K+' },
  { label: 'First Investments', value: '35K+' },
  { label: 'Avg. Learning Rating', value: '4.9' },
]

export const About3 = ({
  title = 'About Faida',
  description = 'Faida is a beginner-friendly investment platform built for students and first-time investors. We help you understand money, learn before you invest, and start with small amounts guided every step of the way.',
  mainImage = {
    src: 'https://images.unsplash.com/photo-1579621970563-ebec7560ff3e?w=1200&h=800&fit=crop',
    alt: 'Students learning about investing',
  },
  secondaryImage = {
    src: 'https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=800&h=600&fit=crop',
    alt: 'Financial literacy and planning',
  },
  breakout = {
    ...
    description:
      'Build financial literacy with bite-sized lessons, clear guidance, and tools designed for small-scale investing.',
    buttonText: 'Explore lessons',
    buttonUrl: '#about',
  },
  companiesTitle = 'Trusted by learners and campus partners',
  companies = defaultCompanies,
  achievementsTitle = 'Our impact in numbers',
  achievementsDescription =
    'Helping beginners build confidence through education, guidance, and accessible small-scale investing.',
